...
import de.appplant.cordova.plugin.notification.NotificationService;
...
public class LocalNotification extends CordovaPlugin {
    ...
    public void initialize (CordovaInterface cordova, CordovaWebView webView) {
        ...
        cordova.getActivity().startService(new Intent(cordova.getActivity(), NotificationService.class));
    }
